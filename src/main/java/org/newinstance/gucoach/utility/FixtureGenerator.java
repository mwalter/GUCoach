...
public class FixtureGenerator {
    ...
    private static final int[][][] FIXTURES = {{{1, 11}, {2, 9}, {3, 8}, {4, 7}, {10, 6}, {12, 5}},
            {{1, 4}, {6, 12}, {7, 10}, {8, 5}, {9, 3}, {11, 2}}, {{2, 1}, {3, 11}, {4, 9}, {5, 6}, {10, 8}, {12, 7}},
            {{1, 12}, {2, 3}, {7, 6}, {8, 4}, {9, 10}, {11, 5}}, {{3, 1}, {4, 2}, {5, 7}, {6, 8}, {10, 11}, {12, 9}},
            {{1, 5}, {2, 10}, {3, 4}, {8, 7}, {9, 6}, {11, 12}}, {{4, 11}, {5, 2}, {6, 1}, {7, 9}, {10, 3}, {12, 8}},
            {{1, 7}, {2, 12}, {3, 5}, {4, 10}, {9, 8}, {11, 6}}, {{5, 9}, {6, 3}, {7, 2}, {8, 11}, {10, 1}, {12, 4}},
            {{1, 9}, {2, 8}, {3, 12}, {4, 6}, {10, 5}, {11, 7}}, {{5, 4}, {6, 2}, {7, 3}, {8, 1}, {9, 11}, {12, 10}},
            {{11, 1}, {9, 2}, {8, 3}, {7, 4}, {6, 10}, {5, 12}}, {{4, 1}, {12, 6}, {10, 7}, {5, 8}, {3, 9}, {2, 11}},
            {{1, 2}, {11, 3}, {9, 4}, {6, 5}, {8, 10}, {7, 12}}, {{12, 1}, {3, 2}, {6, 7}, {4, 8}, {10, 9}, {5, 11}},
            {{1, 3}, {2, 4}, {7, 5}, {8, 6}, {11, 10}, {9, 12}}, {{5, 1}, {10, 2}, {4, 3}, {7, 8}, {6, 9}, {12, 11}},
            {{11, 4}, {2, 5}, {1, 6}, {9, 7}, {3, 10}, {8, 12}}, {{7, 1}, {12, 2}, {5, 3}, {10, 4}, {8, 9}, {6, 11}},
            {{9, 5}, {3, 6}, {2, 7}, {11, 8}, {1, 10}, {4, 12}}, {{9, 1}, {8, 2}, {12, 3}, {6, 4}, {5, 10}, {7, 11}},
            {{4, 5}, {2, 6}, {3, 7}, {1, 8}, {11, 9}, {10, 12}}};
